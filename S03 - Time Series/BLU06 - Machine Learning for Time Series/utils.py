...
def build_features(df, original, num_periods_ahead=1, num_lags=1, num_diffs=0, weekday=False, month=False,
                   rolling=[], rolling_freq='7D', holidays=False, exog=None, num_exog_lags=0, num_exog_diffs=0): 
    """
...
def prepare_data_for_modeling(original, num_lags=1, num_diffs=0, weekday=False, month=False,
                              ...
                              num_periods_ahead=1, target='target', exog=None, num_exog_lags=0, num_exog_diffs=0):
    """ 
    ...
    df_ = build_features(df_, original, num_periods_ahead=num_periods_ahead, num_lags=num_lags, 
                         ...
                         exog=exog, num_exog_lags=num_exog_lags, num_exog_diffs=num_exog_diffs)
...
def build_exog_features(df, exog, num_periods_ahead=1, num_exog_lags=0, num_exog_diffs=0):
    """ 
