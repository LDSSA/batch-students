...
In the last BLU we focused in the two first steps of the data science workflow (the blue boxes in the image), now you will get an idea of the entire pipeline.
...
1. Transforming datasets
    - aggregation
    - method chaining
    - custom methods and pipes 
2. Creating tidy datasets
    - combine, concat, merge, split datasets
    - group-apply-combine
    - inner and outer, left join
3. Pipelines & Transformers
